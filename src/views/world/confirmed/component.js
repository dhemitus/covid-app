      ...
      <div>
        {total !== null &&
          <>
            ...
            <Typography className={clsx(classes.h4, classes.bold)}>{total.TotalCases}</Typography>
            <Typography className={clsx(classes.overline, classes.newcase)}>(+{total.NewCases})</Typography>
          </>
        }
        {/* sum !== null &&
