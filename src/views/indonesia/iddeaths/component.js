      ...
      <div>
        {indonesia !== null &&
          <>
            ...
            <Typography className={clsx(classes.h2, classes.bold)}>{indonesia.TotalDeaths}</Typography>
            <Typography className={clsx(classes.overline, classes.newcase)}>({indonesia.NewDeaths})</Typography>
          </>
        }
        {/* sum !== null &&
