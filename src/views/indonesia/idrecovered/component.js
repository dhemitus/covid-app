  ...
  render() {
    ...
    return (
      <div>
        {indonesia !== null &&
          <>
            <Typography color="textSecondary" className={clsx(classes.body2, classes.title)}>Sembuh</Typography>
            <Typography className={clsx(classes.h2, classes.bold)}>{indonesia.TotalRecovered}</Typography>
          </>
        }
        {/* sum !== null &&
